      ...
      <div class="singer">
         ...
         <div class="selectors">
            <div class="selectorItem">
               ...
               <second-nav-bar :SecondNavBarData="languageSort"
            ...
            <div class="selectorItem">
               ...
               <second-nav-bar :SecondNavBarData="typeSort"
                               @clickSecondBarItem="typeItem"
                               class="secondNavBar"></second-nav-bar>
            </div>
            <div class="selectorItem">
               <div class="title">筛选：</div>
               <second-nav-bar :SecondNavBarData="initialSort"
         ...
         <div class="listCardContainer">
            <!-- 歌手列表 -->
            <list-card class="listCard"
                       :listCardData="singerList"
                       @clickListCardItem="clickListCardItem"
                       isLoad
                       @bottomLoad="bottomLoad"
                       :showPlayCount="false"
                       :showPlayCircle="false"
                       :rowCount="6"></list-card>
         </div>
      </div>
