<template>
   <div class="hotComments">
      ...
      <div class="musicComment"
         ...
         <el-button class="commentCardSwitch"
                    size="mini"
                    round
                    @click="openDialog"><i class="iconfont icon-ziyuan"></i> 发表我的音乐评论</el-button>
         <el-dialog :visible="isCommentDialogShow"
                    width="400px"
            ...
            <div class="submitCommentButton">
               <el-button size="mini"
                          round
                          @click="commentMode ? submitComment() : submitFloorComment()"
                          class="submitComment musicSubmitComment">评论</el-button>
            </div>
         </el-dialog>
      </div>
         ...
         <div class="commentMain">
            <div class="commentContent">
               <span class="commentUserNickName"
                     @click="goToPersonal(item.user.userId)">{{ item.user.nickname }}:&nbsp;</span>
            ...
            <div class="replied">
               <div class="repliedItem"
                  ...
                  <span class="repliedUser"
                        @click="goToPersonal(item.user.userId)">@{{ item1.user.nickname }}:&nbsp;</span>
               ...
               <div class="commentButtons">
                  ...
                  <div>
                     <i class="iconfont icon-pinglun"
                        @click="floorComment(item.commentId, item.user.nickname)"></i>
                  </div>
               </div>
            </div>
         </div>
...
<script>
import { formatDate, formateTime } from "@/utils/formateTime";
